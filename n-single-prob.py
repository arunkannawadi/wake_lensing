import numpy as np
import os
from probability_profiles import *
...
left_cone = _cone.Cone(apex=cone_apex_left, base=cone_base_left, aperture_angle=aperture_angle)
right_cone = _cone.Cone(apex=cone_apex_right, base=cone_base_right, aperture_angle=aperture_angle)
